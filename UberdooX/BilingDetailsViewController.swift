...
class BilingDetailsViewController: UIViewController,UNUserNotificationCenterDelegate,UITableViewDelegate,UITableViewDataSource
{
    ...
    @IBOutlet weak var miscellaneousDetails: UILabel!
    ...
    override func viewDidLoad() {
        ...
        miscellaneousDetails.text = "Miscellaneous Details".localized()
        taxDetails.text = "Tax Details".localized()
        ...
        else
        {
            ...
            str2 = isCoupon_Applied.uppercased()
